...
-- ----------------------------
-- Table structure for path_point
-- ----------------------------
...
CREATE TABLE `path_point` (
  ...
  `first_vertex_id` varchar(255) DEFAULT NULL COMMENT '第一个点的ID',
  PRIMARY KEY (`id`),
  KEY `view_id` (`view_id`),
  KEY `table_id` (`table_id`),
  CONSTRAINT `path_point_ibfk_1` FOREIGN KEY (`view_id`) REFERENCES `table_view` (`id`),
  CONSTRAINT `path_point_ibfk_2` FOREIGN KEY (`table_id`) REFERENCES `data_table_info` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `table_field_info` (
  ...
  `foreign_key` tinyint(1) DEFAULT '0',
  `comment` varchar(255) DEFAULT NULL,
  `add_time` datetime DEFAULT NULL,
  `tb_id` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `view_field` (
  ...
  `view_id` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `view_field_id` (`view_id`),
  CONSTRAINT `view_field_ibfk_1` FOREIGN KEY (`view_id`) REFERENCES `table_view` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `view_field_item` (
  ...
  `view_field_id` bigint(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
DROP TABLE IF EXISTS `view_path_header`;
